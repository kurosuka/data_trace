...
export default {
  ...
  methods: {
    ...
    getPoints(params = {}) {
      ...
      this.$axios({
          method: "get",
          url: `${this.base}/weekSpanValuesReview/getByReviewerId`,
          params,
      }).then(res=> {
    ...
    getUserList() {
      this.$axios({
        method: 'get',
        url: `${this.base}/weekSpanValuesReview/getReviewerList`,
        params: null
      }).then(res=> {
    ...
    saveApi(data = {}) {
      ...
      this.$axios({
        method: 'post',
        url: `${this.base}/weekSpanValuesReview/save`,
